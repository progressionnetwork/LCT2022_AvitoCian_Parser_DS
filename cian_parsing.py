...
def get_apartment_data(html, url):
    ...
    date = get_date(soup)
    images, phone = 'empty', 'null'#driver_get_phone_and_images(url)
...
def main():
    ...
    visited_urls = []
    url_apartments_sell = "https://www.cian.ru/cat.php?deal_type=sale&engine_version=2&offer_type=flat&region=1room1=1&room2=1&room3=1&room4=1&room5=1&room6=1&room7=1&room9=1&page=1"
